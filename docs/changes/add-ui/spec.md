...
## 目的
设计一个基于Flask的Web用户界面，提供图形化操作界面来替代现有的命令行界面，使用户可以通过网页浏览工作目录、选择处理文件、启动处理任务并查看处理结果。

## 需求

### 需求：Web应用框架
系统需要基于Flask框架构建，提供稳定的Web服务。
...
#### 场景：任务状态监控
- 当用户查看任务状态时
- 系统将通过WebSocket或AJAX轮询实时更新任务进度
- 系统将显示处理进度百分比
- 系统将显示实时处理日志
- 系统将更新任务状态（处理中、已完成、失败）
